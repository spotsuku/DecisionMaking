...
export default function Home() {
  ...
  return <main>
    ...
    <section id="top" className="hero">
      ...
      <div className="phoneWrap"><div className="phoneIntro"><span>決断力を高めるアプリ</span><strong>Decision Making</strong></div><div className="shotFrame"><img src="/app/home.webp" width={640} height={1136} fetchPriority="high" decoding="async" alt="迷っていることをそのまま書き出せるアプリのホーム画面" /></div><p className="shotCap">開いたら、すぐ書ける。迷いを話すだけで、決めるべきことはアプリが拾います。</p></div>
    </section>
